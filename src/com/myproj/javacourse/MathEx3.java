...
public class MathEx3 {
	...
	public  String getResults() {
		...
		String line2 = new String ("Calculation 2: Length of opposite where angle B is  " + angle + " and Hypotenuse length " + hypotenuse + " is " + MathEx3.calcOpposite(angle,hypotenuse) + " cm");
